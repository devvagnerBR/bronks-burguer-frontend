...
export default async function HomepageHero() {
    ...
    return (
        <div className="w-full max-w-[1280px] m-auto max-xl:px-4">
            <div className="max-md:items-center max-md:flex max-md:flex-col">
                ...
                <h2 className="text-[34px] pb-6 max-sm:text-[22px] max-sm:max-w-[360px] max-md:text-center font-medium max-w-[480px] mt-4">
                    O {" "}
                    ...
                    hambúrguer de carne que você já comeu.
                </h2>
                <Button.LinkWrapper className="max-w-[250px]" href="/#menu">
